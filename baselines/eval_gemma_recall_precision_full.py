#!/usr/bin/env python3
"""
Gemma-4-E4B baseline (full product info): Exact-class retrieval from a pool of 100 products.
...
Usage
  python eval_gemma_recall_precision_full.py --num-queries 500 --output results/gemma_rp_full.csv
"""
