#!/usr/bin/env python3
"""
Qwen3-32B baseline (full product info): Exact-class retrieval from a pool of 500 products.
...
Usage
  python eval_qwen32b_recall_precision_full.py --num-queries 200 --output results/qwen32b_rp_full.csv
"""
